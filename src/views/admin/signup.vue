<template>
    <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4" style="left:0px;">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav mx-auto ms-xl-auto me-xl-7">
              ...
              <li class="nav-item">
                <a class="nav-link me-2" href="">
                  <i class="fa fa-user-circle opacity-6  me-1"></i>
                  Sign Up
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-2" href="">
                  <i class="fa fa-key opacity-6  me-1"></i>
                  Sign In
                </a>
              </li>
            </ul>
      ...
      <!-- End Navbar -->
      <main class="main-content position-absolute mt-0" style="width:1500px; top: 5px; left:10px;">
        <section class="min-vh-100 mb-8">
          <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('/admin/img/curved-images/curved14.jpg');">
