    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
          <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3">
              <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Quản lý danh mục</h6>
            </li>
            ...
            <li class="nav-item">
              ...
              <a class="nav-link " style="width:100%;"  href="">
                ...
                <span class="nav-link-text ms-1">Độ đo/Tham số</span>
              </a>
              </router-link>
            </li>
            ...
            <li class="nav-item">
              ...
              <a class="nav-link " style="width:100%;"  href="">
                ...
                <span class="nav-link-text ms-1">Bác sỉ/Phòng ban</span>
              </a>
              </router-link>
            </li>
