          ...
          <div class="card-header pb-0 d-flex justify-content-between">
            <h6>Danh sách bệnh</h6>
              ...
              <div class="m-1 ">
                ...
                <button type="button" class="btn btn-primary m-1" data-bs-toggle="modal" data-bs-target="#modal-form-disease" @click="this.newDisease = {}">Thêm mới</button>
                <div class="modal fade" id="modal-form-disease" tabindex="-1" aria-labelledby="modal-form-disease" aria-hidden="true">
                  <ComponentDisease v-bind:newDisease="this.newDisease"  @submit:newDisease="submitDisease()"></ComponentDisease>
                </div>
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  <tr v-for="disease in this.filtereddiseases" :key="disease._id">
                    ...
                    <td>
                      <button v-if="disease.isActive" type="button" class="mt-2 btn btn-outline-success" @click="inactiveDisease(disease.id)">active</button>
                      <button v-else type="button" class="mt-2 btn btn-outline-secondary" @click="activeDisease(disease.id)">inactive</button>
                    </td>
                    <th
                      class="font-weight-bolder mb-0"
                    >
                      <div class="btn-group shadow-0" role="group" aria-label="Basic example">
                        <button type="button" class="btn btn-outline-secondary" data-mdb-color="dark" data-bs-toggle="modal" data-bs-target="#modal-form-disease" @click="this.newDisease=disease"> <i class="fa fa-pencil-alt text-dark"></i></button>
                        <button type="button" class="btn btn-outline-danger" data-mdb-color="dark" @click="this.deleteDisease(disease.id)"><i class="far fa-trash-alt"></i></button>
                      </div>
                    </th>
                  </tr>
                </tbody>
...
export default {
  ...
  methods: {
    ...
    // async updateDisease() {
    //   try {
    //     // console.log("get newDisease");
    //     console.log(this.newDisease)
