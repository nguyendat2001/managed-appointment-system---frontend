        ...
        <div class="col-lg-8 col-md-6">
          <div class="doctor-details mt-4 mt-lg-0">
            ...
            <p>
              ...
              Có nhiều công trình nghiên cứu, bài báo khoa học trong lĩnh vực… Bác sĩ cũng
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
          ...
          <div class="divider my-4"></div>
          <p>
            bác sĩ với kinh nghiệm nhiều năm trong nghề luôn đảm bảo phục vụ hài lòng nhu
            cầu của khách hàng.
          </p>
        </div>
        <div class="col-lg-4">
          <div class="skill-list">
            <!-- <h5 class="mb-4">Chuyên môn</h5> -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="section-title">
            ...
            <p class="" style="text-decoration: underline;">chú ý màu đỏ tức là lịch đã được đặt, màu xanh là lịch trống</p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="accordion accordion-borderless" id="accordionFlushExampleX">
          ...
          <div class="accordion-item" v-for="item in this.workTimes" :key="item.workdays.id">
                <h2 class="accordion-header" id="flush-headingOneX">
                  ...
                  >
                    Ngày :{{item.workdays.day}} || chú ý thời gian bắt đầu trong khoản (10h - 17h)
                  </button>
                </h2>
                <div
                ...
                >
                  <div class="accordion-body p-3">
                    <a v-for="worktime in item.worktimes" :key="worktime.id">
                      <button v-if="worktime.isAvailable" class="btn btn-main btn-round-full m-1" data-toggle="modal" data-target="#exampleModal" @click="this.setworktime(worktime)">{{worktime.time}} - {{this.addMinutes(worktime.time)}}</button>
                      <button v-else class="btn btn-main-2 btn-round-full  m-1" disabled>{{worktime.time}} - {{this.addMinutes(worktime.time)}}</button>
                    </a>
                  </div>
                </div>
          </div>
...
<!-- Modal -->
  <div v-if="this.newAppointment.worktimeDetail" class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
          <div class="modal-body p-0">
            <div class="card card-plain">
              <div class="card-header pb-0 text-left">
                <h3 class="font-weight-bolder text-info text-gradient">Đặt lịch hẹn || Ngày: {{this.newAppointment.worktimeDetail.workday.day}} || Giờ: {{this.newAppointment.worktimeDetail.time}}</h3>
              ...
              <div class="card-body">
                <form role="form text-left" @submit.prevent="submitAppointment()">
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <div class="input-group mb-3">
                        <input type="email" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="password-addon" v-model="this.newAppointment.doctorName" disabled>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="input-group mb-3">
                        <input type="email" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="password-addon" v-model="this.newAppointment.userName" disabled>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="input-group mb-3">
                        <input type="email" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="password-addon" v-model="this.newAppointment.price" disabled>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group-2 mb-4">
                    <textarea name="message" id="message" class="form-control" rows="8" placeholder="Your Message" v-model="this.newAppointment.message" required></textarea>
                  </div>
                  ...
                  <div class="text-center">
                    <h5>Giá Tiền: {{this.newAppointment.price}} VND</h5>
                    <button type="submit" class="btn btn-main btn-round-full w-100 mt-4 mb-0">Thanh Toán</button>
                  </div>
                </form>
              </div>
...
export default {
  ...
  methods: {
    ...
    addMinutes(date) {
        ...
        let time = data[0].toString()+":"+ (parseInt(data[1])+20).toString()+":"+"00" 
        if(parseInt(data[1])+20 == 60 ){
          time = (parseInt(data[0])+1).toString()+":"+"00" +":"+"00" 
        }else{
          time = data[0].toString()+":"+ (parseInt(data[1])+20).toString()+":"+"00" 
        }
        return time
    },
    init() {
