                  ...
                  <table class="table align-items-left mb-0">
                    ...
                    <tbody>
                      <tr v-for="Diagnoses in this.filteredDiagnosess"
                        ...
                        <td>
                          <p class="text-xs font-weight-bold  mt-1 ">{{Diagnoses.describe}}</p>
                          <!-- <p class="text-xs text-secondary mb-0">Organization</p> -->
                        </td>
                        
                        <td>
                          <p class="text-xs font-weight-bold  mt-1 ">{{Diagnoses.technique}}</p>
                          <!-- <p class="text-xs text-secondary mb-0">Organization</p> -->
                        </td>
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Ảnh chuẩn đoán</h5>
              ...
              <div class="modal-body">
                ...
                <div class="row">
                  <div class="col-3" v-for="item in this.DiagnosesImages"  :key="item._id">
                    <div class="card" >
                    <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1">
                      ...
                      <center><p>Ảnh {{item.diagnoses.result}}</p></center>
                    </div>
...
export default {
    ...
    async getAlldisease() {
      ...
      async createDiagnoses(){
        try{
          this.newDiagnoses.doctor = JSON.parse(localStorage.doctor).id
      ...
      async getAllDiagnoses(){
        try{
          this.Diagnosess = await DiagnosesService.getByDoctorAndActive(JSON.parse(localStorage.doctor).id);
