    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
          ...
          <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
            ...
            <span class="ms-1 font-weight-bold">Hệ thống chăm sóc sức khỏe</span>
          </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <router-link class="nav-link "  class-active="active" style="padding:0px 0px 0px 0px; "
                :to="{
                    name: 'doctor.home',
                }"
              > 
            ...
            <li class="nav-item mt-3">
              <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Thông tin</h6>
            </li>
            <!-- <li class="nav-item">
              <router-link class="nav-link "  class-active="active" style="padding:0px 0px 0px 0px; "
                :to="{
              ...
              <a class="nav-link " style="width:100%;"  href="">
                ...
                <span class="nav-link-text ms-1">Phòng/Giường</span>
              </a>
              </router-link>
            </li> -->
            <!-- <li class="nav-item">
              ...
              <a class="nav-link " style="width:100%;"  href="">
                ...
                <span class="nav-link-text ms-1">Phiếu đặt</span>
              </a>
              </router-link>
            </li> -->
            <li class="nav-item">
              ...
              <a class="nav-link " style="width:100%;"  href="">
                ...
                <span class="nav-link-text ms-1">Phiếu chuẩn đoán</span>
              </a>
              </router-link>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link " style="width:100%;"  href="">
                ...
                <span class="nav-link-text ms-1">Đơn thuốc</span>
              </a>
              </router-link>
            </li>
...
export default {
    ...
    watch: {
      "this.$route.name": function(newdata){
