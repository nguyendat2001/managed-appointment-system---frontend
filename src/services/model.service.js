...
class DatasetService {
    constructor(baseUrl = "http://127.0.0.1:9004/api/models") {
    ...
    async getAllSegmentation() {
        return (await this.api.get('/segmentation')).data;
    }

    async getAllClassification() {
        return (await this.api.get('/classification')).data;
    }
    ...
    async getByDataset(id) {
        return (await this.api.get(`/findbydataset/${id}`)).data;
    }
