    ...
    "user", {
        ...
        actions: {
            ...
            async signout() {
                ...
                await localStorage.removeItem('doctor');
                // this.$router.push({
                //     name: "admin.signin",
                // });
            },
            async signIn(username, password) {
                ...
                const resDoc = await DoctorService.getByAccount(this.user.id);
                // console.log(JSON.stringify(resDoc[0]))
                await localStorage.setItem("doctor", JSON.stringify(resDoc[0]));
